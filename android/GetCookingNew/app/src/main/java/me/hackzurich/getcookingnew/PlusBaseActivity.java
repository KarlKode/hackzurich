...
public abstract class PlusBaseActivity extends ActionBarActivity implements
	...
	/**
	 * Called when the {@link com.google.android.gms.plus.PlusClient} is blocking the UI. If you have a
	...
	/**
	 * Connect the {@link com.google.android.gms.plus.PlusClient} only if a connection isn't already in
	...
	/**
	 * Disconnect the {@link com.google.android.gms.plus.PlusClient} only if it is connected (otherwise, it
